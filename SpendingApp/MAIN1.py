                    ...
                    ft.Column(
                        controls=[
                            ft.Row([
                                ...
                                ft.ProgressBar(value=0.7, bgcolor=self.container2_color, border_radius=5, height=5, width=150, color="white"),
                                ft.Text("70 %", color=self.container2_color),
                            ]),
                            ft.Row([
                                ft.Text("Tren", color=self.container2_color, width=40),
                                ft.ProgressBar(value=0.85, bgcolor=self.container2_color, border_radius=5, height=5, width=150, color="white"),
                                ft.Text("85 %", color=self.container2_color),
                            ]),
                            ft.Row([
                                ft.Text("Taxi", color=self.container2_color, width=40),
                                ft.ProgressBar(value=0.65, bgcolor=self.container2_color, border_radius=5, height=5, width=150, color="white"),
                                ft.Text("65 %", color=self.container2_color),
                            ]),
                        ]
                    ),
                ]
                    ...
                    ft.Column(
                        controls=[
                            ft.Row([
                                ...
                                ft.ProgressBar(value=0.75, bgcolor=self.container2_color, border_radius=5, height=5, width=150, color="white"),
                                ft.Text("75 %", color=self.container2_color),
                            ]),
                            ft.Row([
                                ft.Text("Agua", color=self.container2_color, width=60),
                                ft.ProgressBar(value=0.39, bgcolor=self.container2_color, border_radius=5, height=5, width=150, color="white"),
                                ft.Text("39 %", color=self.container2_color),
                            ]),
                            ft.Row([
                                ft.Text("Internet", color=self.container2_color, width=60),
                                ft.ProgressBar(value=0.45, bgcolor=self.container2_color, border_radius=5, height=5, width=150, color="white"),
                ...
                controls=[
                    ft.Column(
                        controls=[
                            ...
                            ft.ProgressBar(value=0.45, bgcolor=self.container2_color, border_radius=5, height=10, width=150, color=self.blue_color)
                        ]
                    ),
                    ft.IconButton(
